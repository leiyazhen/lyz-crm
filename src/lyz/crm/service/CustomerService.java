...
public class CustomerService {
	...
	public void saveNewCustomer(Customer customer) {
		...
		logger.info("{}-添加了新客户-{}", ShiroUtil.getCurrentUserName(),
	...
	public void publicCustomer(Integer id) {
		...
		if (customer == null) {
			...
			if (customer.getUserid().equals(ShiroUtil.getCurrentUserId())) {
				...
				logger.info("{}将客户{}进行了公开", ShiroUtil.getCurrentUserName(),
						customer.getCustname());
			} else {
				throw new ForbiddenException();
			}
	...
	public List<Customer> findCustomerByCurrentUser() {
		return customerMapper.findByUserIdAndEmptyUserId(ShiroUtil
				.getCurrentUserId());
	}
