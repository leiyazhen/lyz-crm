...
public class TaskController {
	...
	public String list(Model model) {
		...
		List<Task> newTaskList = Lists.newArrayList(Collections2.filter(
				taskList, new Predicate<Task>() {
					@Override
		...
		List<Task> doneTaskList = Lists.newArrayList(Collections2.filter(
				taskList, new Predicate<Task>() {
					@Override
					public boolean apply(Task task) {
						return task.getDone();
