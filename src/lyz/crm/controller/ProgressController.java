...
public class ProgressController {
	...
	public String list(
		...
		List<Customer> customerList = customerService
				.findCustomerByCurrentUser();

		Page<Progress> page = progressService.findProgressByPageAndParam(
				userid, progress, date, context, p);
	...
	public String save(Progress progress, @RequestParam MultipartFile[] file,
